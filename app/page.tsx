...
export default function LandingPage() {
  return (
    <div className="min-h-screen flex flex-col bg-[#0a0a0c]" dir="rtl">
...
function Hero() {
  return (
    <section className="relative overflow-hidden min-h-[90vh] flex items-center justify-center bg-[#0d0d0f]">
      ...
      <div className="absolute top-[20%] right-[10%] w-72 h-72 rounded-full bg-[#C9A84C]/[0.04] blur-[100px] animate-float-slow pointer-events-none" />
      <div className="absolute bottom-[15%] left-[5%] w-96 h-96 rounded-full bg-[#C9A84C]/[0.03] blur-[120px] animate-float-delayed pointer-events-none" />
      ...
      <div className="max-w-3xl mx-auto px-6 pt-8 pb-20 text-center relative">
        <ScrollReveal>
          <div className="relative inline-block mb-10 group cursor-default">
            <div className="absolute -inset-10 bg-[#C9A84C]/[0.05] rounded-full blur-[80px] group-hover:bg-[#C9A84C]/[0.09] transition-all duration-700" />
            <Image
              src="https://res.cloudinary.com/daowx6msw/image/upload/v1779318696/hatra_logo_otqaex.png"
              alt="התראה בקליק"
              width={380}
        ...
        <div className="inline-flex items-center gap-2 rounded-full border border-white/[0.08] bg-white/[0.03] backdrop-blur-md px-4 py-1.5 text-sm text-zinc-400 mb-8 fade-in-up" style={{ animationDelay: "0.1s", opacity: 0 }}>
          <span className="w-1.5 h-1.5 rounded-full bg-emerald-500" />
          חינמי לחלוטין, ללא התחייבות
        </div>

        <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold text-white mb-6 leading-[1.05] tracking-tight fade-in-up" style={{ animationDelay: "0.2s", opacity: 0 }}>
          עשו לך עוול?
          <br />
          <span className="text-[#C9A84C]">שלח מכתב התראה</span>
          <br />
          תוך 3 דקות.
        </h1>

        <p className="text-lg md:text-xl text-zinc-400 mb-12 max-w-lg mx-auto leading-relaxed fade-in-up" style={{ animationDelay: "0.35s", opacity: 0 }}>
        ...
        <div className="flex items-center justify-center gap-8 mt-14 text-sm text-zinc-500 fade-in-up" style={{ animationDelay: "0.65s", opacity: 0 }}>
  ...
  return (
    <section className="py-28 px-6 relative bg-[#0a0a0c] overflow-hidden">
      ...
      <ScrollReveal className="absolute top-[5%] left-[4%] pointer-events-none" direction="right" delay={100}>
        <svg className="w-24 h-24 opacity-[0.1] animate-drift-slow" viewBox="0 0 60 60" fill="none" stroke="#C9A84C" strokeWidth="1.3" strokeLinecap="round">
      ...
      <ScrollReveal className="absolute top-[8%] right-[5%] pointer-events-none" direction="left" delay={200}>
        <svg className="w-64 h-64 opacity-[0.11] animate-float-gentle" viewBox="0 0 200 200" fill="none" stroke="#C9A84C" strokeWidth="1.3" strokeLinecap="round">
      ...
      <ScrollReveal className="absolute top-[26%] left-[2%] pointer-events-none" direction="right" delay={300}>
        <svg className="w-52 h-52 opacity-[0.095] -rotate-[15deg] animate-drift-gentle" viewBox="0 0 160 160" fill="none" stroke="#C9A84C" strokeWidth="1.3" strokeLinecap="round">
      ...
      <ScrollReveal className="absolute top-[12%] left-[35%] pointer-events-none" direction="up" delay={180}>
        <svg className="w-36 h-28 opacity-[0.09] rotate-[-2deg] animate-float-gentle" viewBox="0 0 140 90" fill="none" stroke="#C9A84C" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <ScrollReveal className="absolute top-[34%] right-[8%] pointer-events-none" direction="left" delay={350}>
        <svg className="w-20 h-20 opacity-[0.09] animate-drift-slow-reverse" viewBox="0 0 60 60" fill="none" stroke="#C9A84C" strokeWidth="1.2" strokeLinecap="round">
      ...
      <ScrollReveal className="absolute top-[42%] left-[6%] pointer-events-none" direction="right" delay={400}>
        <svg className="w-36 h-48 opacity-[0.095] animate-drift-gentle" viewBox="0 0 80 140" fill="none" stroke="#C9A84C" strokeWidth="1.4" strokeLinecap="round">
      ...
      <ScrollReveal className="absolute top-[20%] right-[28%] pointer-events-none" direction="up" delay={250}>
        <svg className="w-32 h-40 opacity-[0.09] rotate-[6deg] animate-float-gentle" viewBox="0 0 100 130" fill="none" stroke="#C9A84C" strokeWidth="1.2" strokeLinecap="round">
      ...
      <ScrollReveal className="absolute top-[62%] left-[3%] pointer-events-none" direction="right" delay={450}>
        <svg className="w-32 h-40 opacity-[0.085] animate-drift-slow" viewBox="0 0 100 130" fill="none" stroke="#C9A84C" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <ScrollReveal className="absolute top-[38%] left-[38%] pointer-events-none" direction="up" delay={320}>
        <svg className="w-32 h-26 opacity-[0.08] rotate-[3deg] animate-drift-gentle" viewBox="0 0 130 80" fill="none" stroke="#C9A84C" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <ScrollReveal className="absolute top-[55%] right-[4%] pointer-events-none" direction="left" delay={480}>
        <svg className="w-32 h-32 opacity-[0.09] rotate-[-4deg] animate-float-gentle" viewBox="0 0 100 100" fill="none" stroke="#C9A84C" strokeWidth="1.2" strokeLinecap="round">
      ...
      <ScrollReveal className="absolute top-[72%] left-[22%] pointer-events-none" direction="up" delay={500}>
        <svg className="w-20 h-36 opacity-[0.08] rotate-[12deg] animate-drift-slow-reverse" viewBox="0 0 50 100" fill="none" stroke="#C9A84C" strokeWidth="1.1" strokeLinecap="round">
      ...
      <ScrollReveal className="absolute top-[80%] left-[50%] pointer-events-none" direction="up" delay={550}>
        <svg className="w-22 h-22 opacity-[0.09] animate-drift-slow" viewBox="0 0 60 60" fill="none" stroke="#C9A84C" strokeWidth="1.2" strokeLinecap="round">
      ...
      <ScrollReveal className="absolute top-[16%] left-[60%] pointer-events-none" direction="left" delay={280}>
        <svg className="w-28 h-22 opacity-[0.085] rotate-[2deg] animate-drift-gentle" viewBox="0 0 100 70" fill="none" stroke="#C9A84C" strokeWidth="1.1" strokeLinecap="round" strokeLinejoin="round">
      ...
      <ScrollReveal className="absolute top-[74%] right-[12%] pointer-events-none" direction="left" delay={520}>
        <svg className="w-28 h-28 opacity-[0.085] animate-float-gentle" viewBox="0 0 80 80" fill="none" stroke="#C9A84C" strokeWidth="1.2" strokeLinecap="round">
      ...
      <ScrollReveal className="absolute top-[85%] left-[8%] pointer-events-none" direction="right" delay={580}>
        <svg className="w-26 h-26 opacity-[0.08] animate-drift-slow-reverse" viewBox="0 0 80 80" fill="none" stroke="#C9A84C" strokeWidth="1.2" strokeLinecap="round">
      ...
      <ScrollReveal className="absolute top-[30%] right-[20%] pointer-events-none" direction="left" delay={330}>
        <svg className="w-20 h-44 opacity-[0.08] animate-float-gentle" viewBox="0 0 50 120" fill="none" stroke="#C9A84C" strokeWidth="1.1" strokeLinecap="round">
      ...
      <ScrollReveal className="absolute top-[52%] left-[30%] pointer-events-none" direction="up" delay={420}>
        <svg className="w-16 h-16 opacity-[0.08] animate-drift-slow" viewBox="0 0 50 50" fill="none" stroke="#C9A84C" strokeWidth="1.1" strokeLinecap="round">
      ...
      <ScrollReveal className="absolute top-[68%] right-[30%] pointer-events-none" direction="up" delay={470}>
        <svg className="w-24 h-24 opacity-[0.075] rotate-[20deg] animate-drift-gentle" viewBox="0 0 80 80" fill="none" stroke="#C9A84C" strokeWidth="1.2" strokeLinecap="round">
      ...
      <ScrollReveal className="absolute bottom-[6%] left-[42%] pointer-events-none" direction="up" delay={600}>
        <svg className="w-28 h-20 opacity-[0.075] animate-float-gentle" viewBox="0 0 100 60" fill="none" stroke="#C9A84C" strokeWidth="1.1" strokeLinecap="round">
      ...
      <ScrollReveal className="absolute top-[46%] right-[35%] pointer-events-none" direction="up" delay={380}>
        <svg className="w-14 h-24 opacity-[0.07] animate-drift-slow-reverse" viewBox="0 0 40 70" fill="none" stroke="#C9A84C" strokeWidth="1.3" strokeLinecap="round">
      ...
      <ScrollReveal className="absolute top-[3%] left-[57%] pointer-events-none" direction="up" delay={150}>
        <svg className="w-20 h-20 opacity-[0.085] animate-drift-slow-reverse" viewBox="0 0 60 60" fill="none" stroke="#C9A84C" strokeWidth="1.2" strokeLinecap="round">
          <path d="M 15 45 Q 28 43, 30 10 Q 33 43, 45 45" />
          <path d="M 8 48 Q 30 53, 52 48" strokeWidth="0.7" strokeDasharray="3 4" />
        </svg>
      </ScrollReveal>
      ...
      <div className="max-w-4xl mx-auto relative z-[2]">
        <ScrollReveal>
          <div className="text-center mb-20">
            <p className="text-sm font-medium text-[#C9A84C] mb-3 tracking-wide">
              איך זה עובד?
            </p>
      ...
      <div className="max-w-3xl mx-auto">
        <ScrollReveal>
          <div className="text-center mb-16">
            <p className="text-sm font-medium text-[var(--color-gold)] mb-3 tracking-wide">
              למה זה עובד?
            </p>
        ...
        <div className="flex flex-col gap-4">
          {points.map((p, i) => (
            <ScrollReveal key={p.title} delay={i * 100}>
              <div className="flex items-start gap-5 p-6 md:p-7 rounded-lg bg-white border border-[var(--color-muted)] hover:opacity-85 transition-opacity duration-150">
                <div className="w-11 h-11 rounded-lg border border-[var(--color-border)] flex items-center justify-center text-[var(--color-gold)] flex-shrink-0">
                  {p.icon}
                </div>
                <div className="flex-1 min-w-0">
                  <h3 className="text-base font-semibold text-[var(--color-primary)] mb-1.5">
                    {p.title}
                  </h3>
...
function FinalCTA() {
  return (
    <section className="py-28 px-6 relative overflow-hidden bg-[#060607]">
      ...
      <div className="absolute inset-x-0 top-0 h-32 bg-gradient-to-b from-[#0a0a0c] to-transparent pointer-events-none" />
      <div className="absolute inset-0 pointer-events-none" />
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] rounded-full bg-[#C9A84C]/[0.04] blur-[100px] pointer-events-none" />
