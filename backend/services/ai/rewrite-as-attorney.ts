...
## חוק ברזל: חתימה
- בתחילת המכתב: כותב כ: שם העו"ד/המשרד שסופקו בלבד (לא שם הלקוח!)
- בסוף המכתב: "בכבוד רב," ואז שם העו"ד (לא שם הלקוח!)
- אסור בשום מקום לחתום בשם הלקוח. הלקוח מוזכר רק כ"מרשי"
